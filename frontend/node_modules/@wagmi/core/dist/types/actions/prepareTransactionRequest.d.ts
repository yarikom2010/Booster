import type { Account, Address, Calls, Chain, PrepareTransactionRequestErrorType as viem_PrepareTransactionRequestErrorType, PrepareTransactionRequestParameters as viem_PrepareTransactionRequestParameters, PrepareTransactionRequestRequest as viem_PrepareTransactionRequestRequest, PrepareTransactionRequestReturnType as viem_PrepareTransactionRequestReturnType } from 'viem';
import type { Config } from '../createConfig.js';
import type { SelectChains } from '../types/chain.js';
import type { ChainIdParameter } from '../types/properties.js';
import type { IsNarrowable, UnionCompute, UnionStrictOmit } from '../types/utils.js';
export type PrepareTransactionRequestParameters<config extends Config = Config, chainId extends config['chains'][number]['id'] | undefined = config['chains'][number]['id'], request extends viem_PrepareTransactionRequestRequest<SelectChains<config, chainId>[0], SelectChains<config, chainId>[0]> = viem_PrepareTransactionRequestRequest<SelectChains<config, chainId>[0], SelectChains<config, chainId>[0]>, chains extends readonly Chain[] = SelectChains<config, chainId>> = {
    [key in keyof chains]: UnionCompute<(PrepareTransactionRequestParameters_base<config, chainId, request, chains[key]> & {
        calls?: undefined;
        to: Address;
    }) | (UnionStrictOmit<PrepareTransactionRequestParameters_base<config, chainId, request, chains[key]>, 'to'> & {
        calls: Calls<readonly unknown[]>;
        to?: Address | undefined;
    })>;
}[number];
type PrepareTransactionRequestParameters_base<config extends Config, chainId extends config['chains'][number]['id'] | undefined, request extends viem_PrepareTransactionRequestRequest<Chain, Chain>, chain extends Chain> = UnionStrictOmit<viem_PrepareTransactionRequestParameters<chain, Account, chain, Account | Address, request extends viem_PrepareTransactionRequestRequest<chain, chain> ? request : never>, 'chain'> & ChainIdParameter<config, chainId>;
export type PrepareTransactionRequestReturnType<config extends Config = Config, chainId extends config['chains'][number]['id'] | undefined = config['chains'][number]['id'], request extends viem_PrepareTransactionRequestRequest<SelectChains<config, chainId>[0], SelectChains<config, chainId>[0]> = viem_PrepareTransactionRequestRequest<SelectChains<config, chainId>[0], SelectChains<config, chainId>[0]>, chains extends readonly Chain[] = SelectChains<config, chainId>> = {
    [key in keyof chains]: viem_PrepareTransactionRequestReturnType<IsNarrowable<chains[key], Chain> extends true ? chains[key] : undefined, Account, chains[key], Account, request extends viem_PrepareTransactionRequestRequest<IsNarrowable<chains[key], Chain> extends true ? chains[key] : undefined, chains[key]> ? request : never> & {
